  ...
  */
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      var blank = qx.util.ResourceManager.getInstance().toUri("qx/static/blank.html");
      this.__htmlArea = new htmlarea.bom.HtmlArea(this.__htmlAreaContainer, demoContent, null, blank);
   ...
   {
     var attributes = { src    : qx.util.ResourceManager.getInstance().toUri("htmlarea/qooxdoo_logo.png"),
                        border : 0,
                        title  : "qooxdoo logo",
                        alt    : "qooxdoo logo" };
   ...
   __setupToolbar : function()
   {
     var toolbarEntries = [
...

        {
          ...
          fontColor:           { text: "Set Text Color", image:  "htmlarea/format-text-color.png", action: this.__fontColorHandler },
          textBackgroundColor: { text: "Set Text Background Color", image:  "htmlarea/format-fill-color.png", action: this.__textBackgroundColorHandler }
        },
...

        {
          ...
          insertTable:         { text: "Insert Table", image: "htmlarea/insert-table.png", action: this.__insertTableHandler },
          insertLink:          { text: "Insert Link", image: "qx/icon/Oxygen/16/actions/insert-link.png", action: this.__insertLinkHandler },
          insertHTML:          { text: "Insert HTML Code", image: "htmlarea/insert-text.png", action: this.__insertHTMLHandler },
          insertHR:            { text: "Insert Horizontal Ruler", image: "htmlarea/insert-horizontal-rule.png", action: this.__htmlArea.insertHorizontalRuler }
        },

        {
          ol:                  { text: "Insert Ordered List", image: "htmlarea/format-list-ordered.png", action: this.__htmlArea.insertOrderedList },
          ul:                  { text: "Inserted Unordered List", image: "htmlarea/format-list-unordered.png", action: this.__htmlArea.insertUnorderedList }
        },
