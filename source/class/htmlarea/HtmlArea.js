...
/**
 * Rich text editor widget which encapsulates the low-level {@link htmlarea.bom.HtmlArea}
  ...
  */
  ...
  statics :
  {
    ...
    isParagraphParent : function(node) {
      return htmlarea.bom.HtmlArea.isParagraphParent(node);
    }
  },
  ...
  members :
  {
    ...
    */
    ...
    __setupEditorComponent : function()
    {
      ...
      this.__editorComponent = new htmlarea.bom.HtmlArea(domElement,
    ...
    */
     ...
     *
     * @return {htmlarea.bom.manager.Command|htmlarea.bom.manager.UndoRedo?null} manager instance
