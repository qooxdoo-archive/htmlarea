 ...
 */
qx.Class.define("htmlarea.bom.HtmlArea",
{
  ...
  */
  ...
  construct : function(element, value, styleInformation, source)
  {
    ...
    this.__styleInformation = htmlarea.bom.HtmlArea.__formatStyleInformation(styleInformation);
  ...
  */
  ...
  statics :
  {
     ...
     *
     * Example:
     * htmlarea.bom.HtmlArea.__parseStyle("text-align: left; text-weight: bold;");
     *
    ...
    __getHtml : function(root, outputRoot, skipHtmlEncoding, postProcess)
    {
      ...
      switch(root.nodeType)
      {
        ...
        case 11:
          ...
          var closed = (!(root.hasChildNodes() || htmlarea.bom.HtmlArea.__needsClosingTag(root)));
          ...
          if (outputRoot)
          {
            ...
            if ((qx.core.Environment.get("engine.name") == "mshtml"))
            {
              if (tag == "div" && root.className && root.className == "placeholder")
              {
                ...
                {
                  html.push(htmlarea.bom.HtmlArea.__getHtml(i, true, skipHtmlEncoding, postProcess));
                }
                return html.join("");
              }
            }
            ...
            {
              styles = htmlarea.bom.HtmlArea.__parseStyle(attributes.style);
        ...
        case 3:
          ...
          html.push(skipHtmlEncoding ? root.data : htmlarea.bom.HtmlArea.__htmlEncode(root.data));
          break;
    ...
    __needsClosingTag : function(el) {
      return (htmlarea.bom.HtmlArea.closingTags.indexOf(" " + el.tagName + " ") != -1);
    },
  ...
  */
  ...
  members :
  {
     ...
     *
     * @return {htmlarea.bom.manager.Command|htmlarea.bom.manager.UndoRedo} manager instance
     */
    ...
    getWords : function(node)
    {
      ...
      var words = text.match(htmlarea.bom.HtmlArea.GetWordsRegExp);
    ...
    _cleanupWord : function(word)
    {
      ...
      return word.replace(htmlarea.bom.HtmlArea.CleanupWordsRegExp, "");
    },
    ...
    */
    ...
    {
      var cm = new htmlarea.bom.manager.Command(this);
      if (this.getUseUndoRedo()) {
        cm = new htmlarea.bom.manager.UndoRedo(cm, this);
      }
     ...
     * state. Re-initializes the HtmlArea and fires the {@link htmlarea.bom.HtmlArea#readyAfterInvalid}
    ...
    */
    ...
    _handleKeyUp : function(e)
    {
      ...
      if ((qx.core.Environment.get("qx.debug")) &&
          qx.core.Environment.get("htmlarea.bom.HtmlArea.debug")) {
    ...
    __insertWebkitLineBreak : function()
    {
      ...
      this.__commandManager.execute("inserthtml", helperString + htmlarea.bom.HtmlArea.simpleLinebreak);
    },
   ...
   _handleKeyPress : function(e)
   {
        ...
        case "enter":
          ...
          if ((qx.core.Environment.get("engine.name") == "mshtml"))
          {
            if (!this.getInsertParagraphOnLinebreak())
            {
              ...
              // (un)ordered list.
              if (this.__commandManager.execute("inserthtml", htmlarea.bom.HtmlArea.simpleLinebreak))
              {
                this.__startExamineCursorContext();
                e.preventDefault();
                e.stopPropagation();
    ...
    {
      var method = null;
      var hotkeyInfo = htmlarea.bom.HtmlArea.hotkeyInfo;
    ...
    */
    ...
    getHtml : function(skipHtmlEncoding)
    {
      ...
      return htmlarea.bom.HtmlArea.__getHtml(doc.body, false, skipHtmlEncoding, this.getPostProcess());
    },
  ...
  environment : {
    "htmlarea.bom.HtmlArea.debug" : false
  },
