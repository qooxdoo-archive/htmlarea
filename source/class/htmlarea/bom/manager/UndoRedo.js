 ...
 */
qx.Class.define("htmlarea.bom.manager.UndoRedo",
{
   ...
   * Constructor
   *
   * @param commandManager {htmlarea.bom.manager.Command} command manager instance
  ...
  members :
  {
      ...
      "default" : function(undoInfo)
      {
        ...
        if ((qx.core.Environment.get("engine.name") == "gecko"))
        {
          if (undoInfo.command == "inserthtml" &&
              undoInfo.value == htmlarea.bom.HtmlArea.EMPTY_DIV &&
    ...
    __redoCommand : qx.core.Environment.select("engine.name", {
      ...
      "default" : function(redoInfo)
      {
        ...
        if ((qx.core.Environment.get("engine.name") == "gecko"))
        {
          if (this.__checkForNextRedoStep("inserthtml", htmlarea.bom.HtmlArea.EMPTY_DIV))
          {
